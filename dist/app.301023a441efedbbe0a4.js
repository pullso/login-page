...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"login\", function() { return login; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"register\", function() { return register; });\n/* harmony import */ var _plugins_axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../plugins/axios */ \"./js/plugins/axios/index.js\");\n/* harmony import */ var _views_notification__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../views/notification */ \"./js/views/notification.js\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n\n\n/**\r\n * func login. Make login request to API\r\n * @param {String} email\r\n * @param {String} password\r\n */\n\nfunction login(_x, _x2) {\n  return _login.apply(this, arguments);\n}\n\nfunction _login() {\n  _login = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(email, password) {\n    var response;\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            _context.prev = 0;\n            _context.next = 3;\n            return _plugins_axios__WEBPACK_IMPORTED_MODULE_0__[\"default\"].post(\"/auth/login\", JSON.stringify({\n              email: email,\n              password: password\n            }));\n\n          case 3:\n            response = _context.sent;\n            console.log(response);\n            return _context.abrupt(\"return\", response.data);\n\n          case 8:\n            _context.prev = 8;\n            _context.t0 = _context[\"catch\"](0);\n            console.log(_context.t0);\n            return _context.abrupt(\"return\", Promise.reject(_context.t0));\n\n          case 12:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee, null, [[0, 8]]);\n  }));\n  return _login.apply(this, arguments);\n}\n\nfunction register(_x3) {\n  return _register.apply(this, arguments);\n}\n\nfunction _register() {\n  _register = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(obj) {\n    var email, password, first_name, last_name, nickname, phone, gender_orientation, city, country, date_of_birth_day, date_of_birth_month, date_of_birth_year, response;\n    return regeneratorRuntime.wrap(function _callee2$(_context2) {\n      while (1) {\n        switch (_context2.prev = _context2.next) {\n          case 0:\n            _context2.prev = 0;\n            email = obj.email, password = obj.password, first_name = obj.first_name, last_name = obj.last_name, nickname = obj.nickname, phone = obj.phone, gender_orientation = obj.gender_orientation, city = obj.city, country = obj.country, date_of_birth_day = obj.date_of_birth_day, date_of_birth_month = obj.date_of_birth_month, date_of_birth_year = obj.date_of_birth_year;\n            _context2.next = 4;\n            return _plugins_axios__WEBPACK_IMPORTED_MODULE_0__[\"default\"].post(\"/auth/signup\", JSON.stringify({\n              email: email,\n              password: password,\n              nickname: nickname,\n              first_name: first_name,\n              last_name: last_name,\n              phone: phone,\n              gender_orientation: gender_orientation,\n              city: city,\n              country: country,\n              date_of_birth_day: date_of_birth_day,\n              date_of_birth_month: date_of_birth_month,\n              date_of_birth_year: date_of_birth_year\n            }));\n\n          case 4:\n            response = _context2.sent;\n            console.log(response.message);\n\n            if (response.message === 'User created success. On your email sended link. Please verify your email.') {\n              Object(_views_notification__WEBPACK_IMPORTED_MODULE_1__[\"notify\"])({\n                msg: 'Успешная регистрация',\n                className: 'alert-success'\n              });\n            } else {\n              Object(_views_notification__WEBPACK_IMPORTED_MODULE_1__[\"notify\"])({\n                msg: \"\".concat(response.message),\n                className: 'alert-danger'\n              });\n            }\n\n            return _context2.abrupt(\"return\", response);\n\n          case 10:\n            _context2.prev = 10;\n            _context2.t0 = _context2[\"catch\"](0);\n            console.log(_context2.t0);\n            return _context2.abrupt(\"return\", Promise.reject(_context2.t0));\n\n          case 14:\n          case \"end\":\n            return _context2.stop();\n        }\n      }\n    }, _callee2, null, [[0, 10]]);\n  }));\n  return _register.apply(this, arguments);\n}\n\n//# sourceURL=webpack:///./js/services/auth.service.js?");
...
/*!**********************************!*\
  !*** ./js/views/autocomplete.js ***!
  \**********************************/
/*! exports provided: filterAutocomplete */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"filterAutocomplete\", function() { return filterAutocomplete; });\n/* harmony import */ var _config_ui_config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../config/ui.config */ \"./js/config/ui.config.js\");\n/* harmony import */ var _store_locations__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../store/locations */ \"./js/store/locations.js\");\n\n\nvar inputCountry = _config_ui_config__WEBPACK_IMPORTED_MODULE_0__[\"default\"].inputCountry,\n    countriesList = _config_ui_config__WEBPACK_IMPORTED_MODULE_0__[\"default\"].countriesList,\n    inputGender = _config_ui_config__WEBPACK_IMPORTED_MODULE_0__[\"default\"].inputGender;\nfunction filterAutocomplete(input, list, objData) {\n  var countriesArr = [];\n  var fragment = '';\n  list.innerHTML = '';\n\n  if (input.value) {\n    countriesArr = Object.values(objData);\n    var result = countriesArr.filter(function (country) {\n      if (country.toLowerCase().includes(input.value.toLowerCase())) {\n        return true;\n      }\n    });\n\n    if (result.length && result.length < 20) {\n      result.forEach(function (country) {\n        fragment += \"<li class=\\\"list-group-item list-group-item-info\\\">\".concat(country, \"</li>\");\n      });\n      console.log('result: ', result);\n      list.insertAdjacentHTML('afterbegin', fragment);\n    }\n  }\n}\n\n//# sourceURL=webpack:///./js/views/autocomplete.js?");
